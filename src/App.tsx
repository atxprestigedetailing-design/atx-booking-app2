...
const SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbxMtUfZQeMDmt8NoXb3MKB9d4SWao9kTHai0xnVugC44GwZHu86VXrWVkJKQ4WRzz4bdw/exec";
...
const vehicleOptions = [
  ...
  { id: "sedan"    as VehicleType, label: "Sedan",        basicRate: 75, premiumRate: 95  },
  { id: "coupe"    as VehicleType, label: "Coupe",        basicRate: 70, premiumRate: 90  },
  { id: "boat"     as VehicleType, label: "Boat",         basicRate: 95, premiumRate: 105 },
];
...
export default function App() {
  ...
  // ── Prompt sign-in once when a signed-out visitor lands on the home page ──
  useEffect(() => {
    if (step === 0 && !googleUser && !signInPromptShownRef.current) {
